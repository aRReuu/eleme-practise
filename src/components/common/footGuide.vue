    ...
    <footer>
        ...
        <div class="tabbar-items">
            ...
            <router-link :to="`/search/${geohash}`" class="link-item">
                <svg class="item-icon">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.includes('search')== true ? '#searchActive' : '#search'"></use>
                </svg>
                <p>搜索</p>
            </router-link>
